<?php
/**
 * Template Name Posts: Case Study Design
 *
 * Created by PhpStorm.
 * @author: waldemar
 * @date: 06.11.13
...
<?php if (have_posts()): while (have_posts()) : the_post(); ?>
    ...
    <div id="sectionThird" style="padding-bottom: 0">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="design_canvas" style="background: url('<?=get_field('design_image')?>') left top no-repeat; background-size: contain ">
                        <img src="<?php bloginfo('template_directory')?>/assets/img/design.png" >
                    </div>
                </div>
